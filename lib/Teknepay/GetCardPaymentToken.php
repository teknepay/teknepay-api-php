...
class GetCardPaymentToken extends ApiAbstract {
  ...
  protected function _buildRequestMessage() {
    ...
    $request = [
          ...
          "transaction" => [
                              ...
                              "CardHolder" => $this->customer->getHolder(),
                              ...
                              "CC_number" => $this->paymentDetails->getCardNumber(),
                              "CC_exp_month" => $this->paymentDetails->getCardExpMonth(),
                              "CC_exp_year" => substr($this->paymentDetails->getCardExpYear(), -2),
                              "CC_type" => $this->paymentDetails->getCardType(),
                              "CVV" => $this->paymentDetails->getCardCvv(),
                              "PaymentType" => $this->paymentDetails->getPaymentType(),
